  ...
  <div class="resume" id="resume2">
    <div class="left-column">
      <div>
        ...
        <p>
          <span class="txt-full-white"> {{ person.party  }} </span>
          <br />
          <span> 籍贯：{{ person.contact.native }} </span>
        </p>
        <p>
          <span class="txt-full-white"> {{ person.position }} </span>
          <br />
          <span> 联系地址：{{ person.contact.city }} </span>
        </p>
      </div>
    ...
    <div class="right-column">
      ...
      <div v-if="person.projects" class="projects-section section">
        <div class="icon">
          ...
          <span class="section-headline"> Recent {{ lang.projects }} </span>
        </div>
